...
def rmsprop(x, dx, config=None):
    ...
    # config['cache'].                                                        #
    ###########################################################################
    grad_sqrt = config['cache']
    grad_sqrt = config['decay_rate'] * grad_sqrt + (1 - config['decay_rate'])*dx*dx
    next_x = x - config['learning_rate'] * dx/(np.sqrt(grad_sqrt) + config['epsilon'])
    config['cache'] = grad_sqrt
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
